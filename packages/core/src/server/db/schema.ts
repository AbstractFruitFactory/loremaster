...
import { documentTypes } from '../../document.js'
import { EMBEDDING_DIMENSIONS } from '../ai/provider.js'
import type { LoreSource } from '../assistant/types.js'
import { revisionOperations, revisionSources } from '../vault/revisions/types.js'
